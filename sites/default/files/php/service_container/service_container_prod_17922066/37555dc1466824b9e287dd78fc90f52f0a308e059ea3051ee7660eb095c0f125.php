...
class service_container_prod_17922066 extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'migrate.template_storage' => 'getMigrate_TemplateStorageService',
    ...
    /**
     * Gets the 'migrate.template_storage' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\migrate\MigrateTemplateStorage A Drupal\migrate\MigrateTemplateStorage instance.
     */
    protected function getMigrate_TemplateStorageService()
    {
        $this->services['migrate.template_storage'] = $instance = new \Drupal\migrate\MigrateTemplateStorage($this->get('module_handler'));

        $instance->_serviceId = 'migrate.template_storage';
    ...
    {
        $this->services['plugin.manager.migrate.cckfield'] = $instance = new \Drupal\migrate\Plugin\MigratePluginManager('cckfield', $this->get('container.namespaces'), $this->get('cache.discovery'), $this->get('module_handler'));
    ...
    {
        $this->services['plugin.manager.migrate.load'] = $instance = new \Drupal\migrate\Plugin\MigratePluginManager('load', $this->get('container.namespaces'), $this->get('cache.discovery'), $this->get('module_handler'));
    ...
    {
        $this->services['renderer'] = $instance = new \Drupal\Core\Render\Renderer($this->get('controller_resolver'), $this->get('theme.manager'), $this->get('plugin.manager.element_info'), $this->get('render_cache'), array('required_cache_contexts' => array(0 => 'languages:language_interface', 1 => 'theme', 2 => 'user.permissions')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'restui' => array(
                    'type' => 'module',
                    'pathname' => 'modules/restui/restui.info.yml',
            ...
            'container.namespaces' => array(
                ...
                'Drupal\\restui' => 'modules/restui/src',
